          ...
          <form class="swp-login__form" @submit.prevent="submitCredentials">
            <label class="swp-login__field">
              ...
              <span class="swp-login__input-wrap">
                <span class="swp-login__input-icon swp-login__input-icon--user" aria-hidden="true" />
                <input
                  v-model="userName"
                  name="username"
                  type="text"
            ...
            <label class="swp-login__field">
              ...
              <span class="swp-login__password">
                <span class="swp-login__input-icon swp-login__input-icon--lock" aria-hidden="true" />
                <input
                  v-model="password"
                  name="password"
...
.swp-login {
  ...
  background:
    radial-gradient(circle at 18% 18%, rgba(70, 170, 179, 0.16), transparent 34%),
    #06141c;
  ...
  &::after {
    ...
    content: "";
    background:
      linear-gradient(90deg, rgba(4, 17, 27, 0.08), transparent 52%, rgba(2, 12, 20, 0.26)),
      linear-gradient(180deg, rgba(3, 13, 21, 0.08), transparent 42%, rgba(1, 9, 15, 0.52));
  }
  ...
  &__shade {
    z-index: 1;
    background:
      linear-gradient(90deg, rgba(3, 13, 21, 0.08) 0%, rgba(3, 13, 21, 0.12) 48%, rgba(3, 13, 21, 0.7) 100%),
      linear-gradient(180deg, rgba(3, 13, 21, 0.18), transparent 44%, rgba(3, 13, 21, 0.62));
  ...
  &__card {
    ...
    min-height: 0;
    flex-direction: column;
    padding: clamp(28px, 4.2vh, 48px) clamp(26px, 3vw, 46px) clamp(20px, 3vh, 30px);
    overflow-y: auto;
...
@media (max-width: 768px) {
  .swp-login {
    ...
    &__shade {
      background:
        linear-gradient(180deg, rgba(3, 13, 21, 0.1) 0%, rgba(3, 13, 21, 0.04) 26%, rgba(3, 13, 21, 0.9) 69%, #06141c 100%);
      box-shadow: none;
    }

    &::after {
      background: linear-gradient(180deg, transparent 25%, rgba(2, 11, 17, 0.34) 56%, rgba(2, 11, 17, 0.76));
    }
