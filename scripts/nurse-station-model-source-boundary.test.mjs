...
const modelUrl = '/models/smart-ward-nurse-station/1-1.glb?v=20260901-h-n2-v1';
...
assert.equal(modelUrl, '/models/smart-ward-nurse-station/1-1.glb?v=20260901-h-n2-v1');
