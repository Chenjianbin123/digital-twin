...
assert.match(app, /NurseStationVisualScene[\s\S]*?v-if="isNurseStation"/);
...
assert.match(visualScene, /bottom:\s*calc\(42vh \+ 20px\)/);
...
assert.match(sceneConfig, /high_fidelity_nurse_station_v3\.glb\?v=20260820-latest-blender-v3-export-v20/);
