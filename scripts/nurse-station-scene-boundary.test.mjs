...
assert.match(areaScene, /this\.corridorTheme\(this\.nurseStationModel, this\.darkTheme\);/);
assert.match(areaScene, /if \(this\.nurseStationModel\)\s*polishHospitalCorridorMaterials\(this\.nurseStationModel\);/);
