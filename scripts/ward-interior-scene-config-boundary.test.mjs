...
test('病房内部场景参数集中在独立配置文件中', async () => {
  ...
  assert.match(config, /smart_ward_interior\.glb\?v=20260812-terminal-layout-v4/);
  ...
  assert.match(config, /background: 0xe8eeea/);
  assert.match(config, /baseFogDensity: 0\.012/);
